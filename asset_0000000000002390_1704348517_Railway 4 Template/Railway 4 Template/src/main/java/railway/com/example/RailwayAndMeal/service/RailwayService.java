...
public class RailwayService {
	...
	**/
		if(ObjectUtils.isEmpty(ticketMap.get(pnr))) {
			throw new TicketNotFoundException("Ticket Not found with this pnr"+pnr);
		}
	...
	**/
		if(ObjectUtils.isEmpty(ticketMap.get(ticket.getPnr()))) {
			...
			throw new TicketAlreadyExistsException("Ticket Already Found by this pnr "+ticket.getPnr());
		}
	...
	public void updateTicket(Ticket ticket) {
		if(ObjectUtils.isEmpty(ticketMap.get(ticket.getPnr()))) {
			throw new TicketNotFoundException("Ticket Not found with this pnr"+ticket.getPnr());
		}
		else {
